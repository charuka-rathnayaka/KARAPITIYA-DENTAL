        ...
        <div class="navbar">
           ...
           ?> <div class="sub_header">
            ...
            <ul class="contactMethods">
                <li>
                    <img src="icons/Phone.svg" alt="phone" class="phoneIcon">
                    <p>Hotline</p>
                    <p>0912 232 267</p>
                </li>
                <li>
                    <img src="icons/Email.svg" alt="email" class="emailIcon">
                    <p>Email</p>
                    <p>dental@karaptiyateachinghospital.com</p>
                </li>
                <li>
                    <img src="icons/Address.svg" alt="address" class="addressIcon">
                    <p>Address</p>
                    <p>Dental clinic, Teaching hospital, Karapitiya, Galle 80000</p>
                </li>
