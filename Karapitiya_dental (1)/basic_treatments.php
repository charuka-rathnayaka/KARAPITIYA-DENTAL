            ...
            <div class="treatmentsContainer">
                ...
                <script>
                    ...
                    function hideAll(){
                        ...
                        t1.style.backgroundColor="rgb(57,175,169)";
                        t2.style.backgroundColor="rgb(57,175,169)";
                        t3.style.backgroundColor="rgb(57,175,169)";
                        t4.style.backgroundColor="rgb(57,175,169)";
                    }
                    function showDetail1(){
                        hideAll();
                        x1.style.display = "block";
                        t1.style.backgroundColor="rgb(23,37,42)";
                    }
                    function showDetail2(){
                        hideAll();
                        x2.style.display = "block";
                        t2.style.backgroundColor="rgb(23,37,42)";
                    }
                    function showDetail3(){
                        hideAll();
                        x3.style.display = "block";
                        t3.style.backgroundColor="rgb(23,37,42)";
                    }
                    function showDetail4(){
                        hideAll();
                        x4.style.display = "block";
                        t4.style.backgroundColor="rgb(23,37,42)";
                    }
                </script>
            </div>
        </div>
